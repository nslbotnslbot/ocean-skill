#!/usr/bin/env python3
"""Create an OCEAN source packet for an inspected WDL-Cromwell run.

This wrapper does not install, call, or validate WDL-Cromwell. It converts a
...
TOOL_NAME = 'WDL-Cromwell'
TOOL_SLUG = 'wdl_cromwell'
