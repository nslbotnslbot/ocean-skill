...
OCEAN wrapper contract for `Galaxy`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `Galaxy`. Local availability must be checked before use.
