...
OCEAN wrapper contract for `CheckM`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `CheckM`. Local availability must be checked before use.
