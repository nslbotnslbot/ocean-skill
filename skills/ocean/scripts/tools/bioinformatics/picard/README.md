...
OCEAN wrapper contract for `Picard`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `Picard`. Local availability must be checked before use.
