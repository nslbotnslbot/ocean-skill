...
OCEAN wrapper contract for `fastp`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `fastp`. Local availability must be checked before use.
