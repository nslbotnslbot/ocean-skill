...
OCEAN wrapper contract for `HMMER`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `HMMER`. Local availability must be checked before use.
