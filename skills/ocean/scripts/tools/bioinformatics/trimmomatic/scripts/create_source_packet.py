#!/usr/bin/env python3
"""Create an OCEAN source packet for an inspected Trimmomatic run.

This wrapper does not install, call, or validate Trimmomatic. It converts a
