...
OCEAN wrapper contract for `Trimmomatic`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `Trimmomatic`. Local availability must be checked before use.
