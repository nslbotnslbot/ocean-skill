...
OCEAN wrapper contract for `Tangram`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `Tangram`. Local availability must be checked before use.
