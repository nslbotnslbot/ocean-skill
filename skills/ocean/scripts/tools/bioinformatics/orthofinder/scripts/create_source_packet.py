#!/usr/bin/env python3
"""Create an OCEAN source packet for an inspected OrthoFinder run.

This wrapper does not install, call, or validate OrthoFinder. It converts a
