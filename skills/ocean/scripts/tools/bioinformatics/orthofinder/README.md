...
OCEAN wrapper contract for `OrthoFinder`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `OrthoFinder`. Local availability must be checked before use.
