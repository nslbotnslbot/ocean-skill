...
OCEAN wrapper contract for `STARsolo`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `STARsolo`. Local availability must be checked before use.
