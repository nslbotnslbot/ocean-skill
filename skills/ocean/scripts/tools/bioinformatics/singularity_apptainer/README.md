...
OCEAN wrapper contract for `Singularity-Apptainer`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `Singularity-Apptainer`. Local availability must be checked before use.
