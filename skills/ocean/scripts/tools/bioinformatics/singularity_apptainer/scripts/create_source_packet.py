#!/usr/bin/env python3
"""Create an OCEAN source packet for an inspected Singularity-Apptainer run.

This wrapper does not install, call, or validate Singularity-Apptainer. It converts a
...
TOOL_NAME = 'Singularity-Apptainer'
TOOL_SLUG = 'singularity_apptainer'
