...
OCEAN wrapper contract for `STAR`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `STAR`. Local availability must be checked before use.
