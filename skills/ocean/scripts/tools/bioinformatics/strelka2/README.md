...
OCEAN wrapper contract for `Strelka2`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `Strelka2`. Local availability must be checked before use.
