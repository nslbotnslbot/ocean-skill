#!/usr/bin/env python3
"""Create an OCEAN source packet for an inspected CellTypist run.

This wrapper does not install, call, or validate CellTypist. It converts a
