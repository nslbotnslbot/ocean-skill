...
OCEAN wrapper contract for `SAMtools`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `SAMtools`. Local availability must be checked before use.
