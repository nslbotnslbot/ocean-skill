...
This OCEAN guide defines bounded use, required run evidence, and stop conditions for `HH-suite`. It is not a standalone Codex skill and does not mean the tool is installed locally.
