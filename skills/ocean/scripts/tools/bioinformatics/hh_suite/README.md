...
OCEAN wrapper contract for `HH-suite`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `HH-suite`. Local availability must be checked before use.
