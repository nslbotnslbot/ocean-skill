...
OCEAN wrapper contract for `cell2location`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `cell2location`. Local availability must be checked before use.
