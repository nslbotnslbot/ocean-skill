#!/usr/bin/env python3
"""Create an OCEAN source packet for an inspected cell2location run.

This wrapper does not install, call, or validate cell2location. It converts a
