#!/usr/bin/env python3
"""Create an OCEAN source packet for an inspected eggNOG-mapper run.

This wrapper does not install, call, or validate eggNOG-mapper. It converts a
