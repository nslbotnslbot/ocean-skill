#!/usr/bin/env python3
"""Create an OCEAN source packet for an inspected Trim Galore run.

This wrapper does not install, call, or validate Trim Galore. It converts a
