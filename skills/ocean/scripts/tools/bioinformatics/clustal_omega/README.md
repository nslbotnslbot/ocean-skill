...
OCEAN wrapper contract for `Clustal Omega`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `Clustal Omega`. Local availability must be checked before use.
