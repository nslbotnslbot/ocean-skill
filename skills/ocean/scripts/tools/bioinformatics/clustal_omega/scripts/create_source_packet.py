#!/usr/bin/env python3
"""Create an OCEAN source packet for an inspected Clustal Omega run.

This wrapper does not install, call, or validate Clustal Omega. It converts a
