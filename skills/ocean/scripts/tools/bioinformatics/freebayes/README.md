...
OCEAN wrapper contract for `FreeBayes`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `FreeBayes`. Local availability must be checked before use.
