...
OCEAN wrapper contract for `FastQC`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `FastQC`. Local availability must be checked before use.
