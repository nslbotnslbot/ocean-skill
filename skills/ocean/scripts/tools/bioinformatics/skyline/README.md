...
OCEAN wrapper contract for `Skyline`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `Skyline`. Local availability must be checked before use.
