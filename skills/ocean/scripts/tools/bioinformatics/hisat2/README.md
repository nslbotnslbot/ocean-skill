...
OCEAN wrapper contract for `HISAT2`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `HISAT2`. Local availability must be checked before use.
