...
OCEAN wrapper contract for `RSEM`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `RSEM`. Local availability must be checked before use.
