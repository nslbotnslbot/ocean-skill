...
OCEAN wrapper contract for `Giotto`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `Giotto`. Local availability must be checked before use.
