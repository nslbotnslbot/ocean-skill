...
OCEAN wrapper contract for `MONAI`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `MONAI`. Local availability must be checked before use.
