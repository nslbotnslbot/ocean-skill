...
OCEAN wrapper contract for `MACS2`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `MACS2`. Local availability must be checked before use.
