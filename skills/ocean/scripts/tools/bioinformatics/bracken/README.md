...
OCEAN wrapper contract for `Bracken`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `Bracken`. Local availability must be checked before use.
