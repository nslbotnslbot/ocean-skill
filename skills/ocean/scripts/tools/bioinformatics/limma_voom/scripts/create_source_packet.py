#!/usr/bin/env python3
"""Create an OCEAN source packet for an inspected limma-voom run.

This wrapper does not install, call, or validate limma-voom. It converts a
