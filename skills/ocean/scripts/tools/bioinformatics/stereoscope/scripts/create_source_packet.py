#!/usr/bin/env python3
"""Create an OCEAN source packet for an inspected Stereoscope run.

This wrapper does not install, call, or validate Stereoscope. It converts a
...
TOOL_NAME = 'Stereoscope'
TOOL_SLUG = 'stereoscope'
