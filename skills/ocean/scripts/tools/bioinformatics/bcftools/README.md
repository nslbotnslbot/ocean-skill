...
OCEAN wrapper contract for `bcftools`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `bcftools`. Local availability must be checked before use.
