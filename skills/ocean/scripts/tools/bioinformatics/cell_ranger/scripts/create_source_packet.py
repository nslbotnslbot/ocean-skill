#!/usr/bin/env python3
"""Create an OCEAN source packet for an inspected Cell Ranger run.

This wrapper does not install, call, or validate Cell Ranger. It converts a
...
TOOL_NAME = 'Cell Ranger'
TOOL_SLUG = 'cell_ranger'
