...
OCEAN wrapper contract for `LAST`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `LAST`. Local availability must be checked before use.
