...
OCEAN wrapper contract for `nf-core`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `nf-core`. Local availability must be checked before use.
