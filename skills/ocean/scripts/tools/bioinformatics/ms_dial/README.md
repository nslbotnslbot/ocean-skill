...
OCEAN wrapper contract for `MS-DIAL`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `MS-DIAL`. Local availability must be checked before use.
