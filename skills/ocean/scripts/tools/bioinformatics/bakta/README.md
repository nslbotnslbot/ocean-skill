...
OCEAN wrapper contract for `Bakta`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `Bakta`. Local availability must be checked before use.
