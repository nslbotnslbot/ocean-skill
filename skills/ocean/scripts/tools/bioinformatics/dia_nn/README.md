...
OCEAN wrapper contract for `DIA-NN`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `DIA-NN`. Local availability must be checked before use.
