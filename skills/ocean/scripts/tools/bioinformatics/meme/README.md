...
OCEAN wrapper contract for `MEME`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `MEME`. Local availability must be checked before use.
