...
OCEAN wrapper contract for `GATK`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `GATK`. Local availability must be checked before use.
