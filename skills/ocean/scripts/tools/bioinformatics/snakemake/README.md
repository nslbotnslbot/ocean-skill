...
OCEAN wrapper contract for `Snakemake`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `Snakemake`. Local availability must be checked before use.
