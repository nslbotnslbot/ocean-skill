...
OCEAN wrapper contract for `Azimuth`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `Azimuth`. Local availability must be checked before use.
