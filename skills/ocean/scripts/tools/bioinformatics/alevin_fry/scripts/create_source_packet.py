#!/usr/bin/env python3
"""Create an OCEAN source packet for an inspected Alevin-fry run.

This wrapper does not install, call, or validate Alevin-fry. It converts a
...
TOOL_NAME = 'Alevin-fry'
TOOL_SLUG = 'alevin_fry'
