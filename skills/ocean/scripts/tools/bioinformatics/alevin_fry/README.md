...
OCEAN wrapper contract for `Alevin-fry`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `Alevin-fry`. Local availability must be checked before use.
