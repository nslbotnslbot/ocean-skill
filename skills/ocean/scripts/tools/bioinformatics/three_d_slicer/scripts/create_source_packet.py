#!/usr/bin/env python3
"""Create an OCEAN source packet for an inspected 3D Slicer run.

This wrapper does not install, call, or validate 3D Slicer. It converts a
