...
OCEAN wrapper contract for `minimap2`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `minimap2`. Local availability must be checked before use.
