...
OCEAN wrapper contract for `Kraken2`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `Kraken2`. Local availability must be checked before use.
