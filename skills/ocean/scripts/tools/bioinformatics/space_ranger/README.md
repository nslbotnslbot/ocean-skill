...
OCEAN wrapper contract for `Space Ranger`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `Space Ranger`. Local availability must be checked before use.
