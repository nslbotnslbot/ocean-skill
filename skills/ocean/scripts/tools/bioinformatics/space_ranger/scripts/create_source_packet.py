#!/usr/bin/env python3
"""Create an OCEAN source packet for an inspected Space Ranger run.

This wrapper does not install, call, or validate Space Ranger. It converts a
...
TOOL_NAME = 'Space Ranger'
TOOL_SLUG = 'space_ranger'
