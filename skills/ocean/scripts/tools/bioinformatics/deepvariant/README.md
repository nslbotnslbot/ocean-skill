...
OCEAN wrapper contract for `DeepVariant`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `DeepVariant`. Local availability must be checked before use.
