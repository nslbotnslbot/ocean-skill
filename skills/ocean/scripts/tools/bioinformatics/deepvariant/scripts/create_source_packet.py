#!/usr/bin/env python3
"""Create an OCEAN source packet for an inspected DeepVariant run.

This wrapper does not install, call, or validate DeepVariant. It converts a
