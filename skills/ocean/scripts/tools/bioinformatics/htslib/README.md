...
OCEAN wrapper contract for `HTSlib`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `HTSlib`. Local availability must be checked before use.
