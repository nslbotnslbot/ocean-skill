...
OCEAN wrapper contract for `edgeR`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `edgeR`. Local availability must be checked before use.
