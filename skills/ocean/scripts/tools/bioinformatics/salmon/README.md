...
OCEAN wrapper contract for `Salmon`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `Salmon`. Local availability must be checked before use.
