#!/usr/bin/env python3
"""Create an OCEAN source packet for an inspected featureCounts run.

This wrapper does not install, call, or validate featureCounts. It converts a
