...
OCEAN wrapper contract for `featureCounts`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `featureCounts`. Local availability must be checked before use.
