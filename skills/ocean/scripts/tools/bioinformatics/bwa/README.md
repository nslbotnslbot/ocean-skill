...
OCEAN wrapper contract for `BWA`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `BWA`. Local availability must be checked before use.
