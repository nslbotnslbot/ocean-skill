...
OCEAN wrapper contract for `MultiQC`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `MultiQC`. Local availability must be checked before use.
