...
OCEAN wrapper contract for `DIABLO`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `DIABLO`. Local availability must be checked before use.
