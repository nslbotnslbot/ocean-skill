...
OCEAN wrapper contract for `Nextflow`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `Nextflow`. Local availability must be checked before use.
