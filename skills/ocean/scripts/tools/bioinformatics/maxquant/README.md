...
OCEAN wrapper contract for `MaxQuant`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `MaxQuant`. Local availability must be checked before use.
