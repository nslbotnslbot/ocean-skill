...
OCEAN wrapper contract for `Prokka`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `Prokka`. Local availability must be checked before use.
