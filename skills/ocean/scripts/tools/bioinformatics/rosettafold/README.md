...
OCEAN wrapper contract for `RoseTTAFold`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `RoseTTAFold`. Local availability must be checked before use.
