#!/usr/bin/env python3
"""Create an OCEAN source packet for an inspected RoseTTAFold run.

This wrapper does not install, call, or validate RoseTTAFold. It converts a
...
TOOL_NAME = 'RoseTTAFold'
TOOL_SLUG = 'rosettafold'
