...
OCEAN wrapper contract for `DESeq2`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `DESeq2`. Local availability must be checked before use.
