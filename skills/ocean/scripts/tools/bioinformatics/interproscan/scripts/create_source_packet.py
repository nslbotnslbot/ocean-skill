#!/usr/bin/env python3
"""Create an OCEAN source packet for an inspected InterProScan run.

This wrapper does not install, call, or validate InterProScan. It converts a
