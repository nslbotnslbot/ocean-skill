...
OCEAN wrapper contract for `MEGAHIT`.
...
This folder defines bounded wrapper code, examples, and source-packet rules for `MEGAHIT`. Local availability must be checked before use.
