...
| Harbor | Decision Memory | final memo, evidence boundary ledger, contribution boundary record, next-action register, stale-evidence flags, reuse note | add new evidence, publish private project material, or decide authorship/publication from missing records |
