...
```text
validation/release-validation-log.md
```
...
|---|---|---|---|
| Sounding R1 API slices | Small live API checks for Codex/OpenAI, DeepSeek, and Gemini behavior | Completed slices recorded in `validation/` | Workflow/format and evidence-boundary behavior only |
