...
| Reef | Initial standalone coverage plus M2 screen | M1 Reef cases, M2 heuristic scoring, Reef-R1 resource/provenance traps, and biological/clinical data-source routing scaffold | KG/database/clinical-data provenance eval with real resource records |
